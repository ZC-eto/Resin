...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "最近扫描": "Last scan",
  "最近扫描：{{time}}": "Last scan: {{time}}",
  "最近完成：{{time}}": "Last finished: {{time}}",
  "最近画像错误：{{message}}": "Recent profiling error: {{message}}",
  "长期失效节点清理": "Long-term Failed Node Cleanup",
  "对持续多轮探测都失败的节点执行全局硬删除。关闭时不会自动清理；开启后会根据失败窗口与真实探测时间推进决定是否删除。":
    "Hard-delete nodes globally only when they keep failing across multiple observed probe cycles. When disabled, no automatic cleanup runs.",
  "自动清理任务": "Auto cleanup task",
  "跟踪候选": "Tracked candidates",
  "上轮删除": "Deleted last run",
  "启用长期失效节点自动清理": "Enable automatic cleanup for long-term failed nodes",
  "长期失效节点清理窗口": "Failed node cleanup window",
  "例如 72h 或 168h。只有失败窗口跨越这段时间且期间持续观察到失败探测，节点才会被全局删除。":
    "For example 72h or 168h. Nodes are deleted globally only when the observed failed-probe window spans this duration.",
  "已停用": "Disabled",
  "启用": "Enabled",
  "仅启用": "Enabled only",
  "仅禁用": "Disabled only",
  ...
  "上次探测": "Last Probe",
  "上次延迟探测": "Last Latency Probe",
  "上次检查": "Last Check",
  "上次更新": "Last Updated",
  "待出口探测": "Pending Egress Probe",
  "正在探测出口": "Probing egress",
  "未开始探测": "Not probed yet",
  "画像排队中": "Queued for profiling",
  "画像检测中": "Profiling in progress",
  "待画像": "Pending profiling",
  "已画像": "Profiled",
  "已画像但仍未知": "Profiled but still unknown",
  "已完成画像": "Profile complete",
  ...
  "本地": "Local",
  "单一来源": "Single source",
  "共 {{count}} 个来源": "{{count}} sources",
  "添加远程": "Add remote",
  "添加本地": "Add local",
  "删除来源": "Delete source",
  "启用该来源": "Enable this source",
  "一个订阅可同时挂多个远程链接或本地内容，刷新时会合并处理。":
    "A subscription can include multiple remote links and local contents; they will be merged on refresh.",
  "支持同时填写多个远程 URL 和多个本地内容块，系统会在一次刷新里统一合并解析。":
    "You can add multiple remote URLs and local content blocks; they will be parsed together in one refresh.",
  "本地内容会直接参与解析": "Local content is parsed directly",
  "远程来源会先拉取再解析": "Remote sources are fetched before parsing",
  "例如主线路 / 备用 1": "e.g. primary / backup 1",
  ...
  "接入模式": "Access Mode",
  "粘性代理模式": "Sticky Proxy Mode",
  "轮换策略": "Rotation Policy",
  "轮换周期": "Rotation Interval",
  "保持原出口": "Keep current egress",
  "按时间轮换": "Rotate on interval",
  "不自动轮换": "No automatic rotation",
  "保持当前出口，直到故障或手动切换。": "Keep the current egress until failure or a manual rotate.",
  "到达轮换周期后，下次请求会重新分配出口。": "When the interval elapses, the next request will be reassigned.",
  "例如 2m / 30m / 2h": "For example: 2m / 30m / 2h",
  "按时间轮换时必须填写轮换周期": "Rotation interval is required when using timed rotation",
  "开启后默认导出 Platform.Account 的粘性代理地址。": "When enabled, export sticky proxy URLs using the Platform.Account form by default.",
  "当前平台默认导出粘性代理地址，适合固定账号长期复用。":
    "This platform now exports sticky proxy URLs by default, suitable for long-lived fixed accounts.",
  "当前平台默认导出普通代理地址，适合外部服务直接填入。":
    "This platform now exports standard proxy URLs by default, suitable for third-party services that only accept one proxy address.",
  "接入模板": "Access Templates",
  "直接复制到浏览器、脚本或外部服务里使用。": "Copy directly into browsers, scripts, or external services.",
  "代理域名或地址": "Proxy Host or Domain",
  "代理端口": "Proxy Port",
  "代理 Token": "Proxy Token",
  "示例账号": "Sample Account",
  "普通代理地址": "Standard Proxy URL",
  "普通代理地址已复制": "Standard proxy URL copied",
  "适合只能填写一个 HTTP 代理地址的浏览器或第三方软件。":
    "Best for browsers or third-party tools that only allow a single HTTP proxy URL.",
  "粘性代理地址": "Sticky Proxy URL",
  "粘性代理地址已复制": "Sticky proxy URL copied",
  "固定账号时优先复用原出口 IP，适合登录、养号、长会话。":
    "Reuses the previous egress IP for the same account when possible, suitable for login, account farming, and long sessions.",
  "多账号模板": "Multi-Account Template",
  "多账号模板已复制": "Multi-account template copied",
  "把 {account} 替换成你的业务账号名，每个账号都会独立保持粘性。":
    "Replace {account} with your business account name. Each account keeps its own sticky lease.",
  "Rotate API 地址": "Rotate API URL",
  "Rotate API 地址已复制": "Rotate API URL copied",
  "当当前账号 IP 被风控时，可单独调用这个接口让下次请求换出口。":
    "Call this endpoint when the current account IP gets blocked, so the next request can switch egress.",
  "当前浏览器无法直接复制，请手动复制文本。": "Clipboard copy is unavailable in this browser. Please copy manually.",
  "请输入需要切换的账号": "Please enter the account to rotate",
  "切换指定账号 IP": "Rotate Selected Account IP",
  "输入账号后执行 rotate，下次该账号请求会重新分配出口。":
    "Enter an account and run rotate. Its next request will be assigned a new egress.",
  "输入账号，例如 account_001": "Enter an account, e.g. account_001",
  "切换中...": "Rotating...",
  "切换 IP": "Rotate IP",
  "平台 {{name}} 的账号 {{account}} 已触发换 IP": "Rotate IP triggered for account {{account}} on platform {{name}}",
  "返回列表": "Back to List",
  ...
  "更新来源列表、刷新周期与状态开关后点击保存。":
    "Update source list, refresh interval, and enable switches, then save.",
  ...
  "节点画像任务": "Node profiling tasks",
  "节点画像": "Node profiling",
  "本地库负责预判明显机房/匿名节点，在线补充主要用来识别住宅类型。保存后立即生效；如需把新规则应用到现有节点，可手动触发一次批量重检。":
    "Local databases pre-classify obvious datacenter or anonymous nodes, while online enrichment mainly identifies residential types. Changes take effect immediately; use a bulk recheck to apply new rules to existing nodes.",
  "启用本地画像预判": "Enable local pre-classification",
  "启用后台画像补全": "Enable background profile enrichment",
  "出口变化后自动刷新画像": "Refresh profile when egress changes",
  "在线画像提供方": "Online profiling provider",
  "推荐使用 ProxyCheck 免费方案。禁用在线补充时，只会使用本地预判和历史缓存。":
    "ProxyCheck free tier is recommended. When online enrichment is disabled, only local pre-classification and cached results are used.",
  "在线画像密钥": "Online profiling API key",
  "仅管理员可见。若使用免费 ProxyCheck，请填它的免费 API key。":
    "Visible to admins only. If you use the free ProxyCheck tier, enter its API key.",
