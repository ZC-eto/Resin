...
CREATE TABLE IF NOT EXISTS request_logs (
	...
	lease_action          TEXT NOT NULL DEFAULT '',
	rotate_requested      INTEGER NOT NULL DEFAULT 0,
	rotate_applied        INTEGER NOT NULL DEFAULT 0,
	rotate_source         TEXT NOT NULL DEFAULT '',
	target_host           TEXT NOT NULL DEFAULT '',
	target_url            TEXT NOT NULL DEFAULT '',
	node_hash             TEXT NOT NULL DEFAULT '',
	node_tag              TEXT NOT NULL DEFAULT '',
	egress_ip             TEXT NOT NULL DEFAULT '',
	previous_egress_ip    TEXT NOT NULL DEFAULT '',
	egress_network_type   TEXT NOT NULL DEFAULT '',
